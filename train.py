...
from rivertrainer import trainer_river
...
parser.add_argument('--output', type=str, default='/outputs/sam/results', help='store log outputs')
...
parser.add_argument('--pre_computed_dataset_path', type=str, default=None, help='save dataset')
parser.add_argument('--tif_dir', type=str, default=None, help='path to image dataset')
parser.add_argument('--shp_dir', type=str, default=None, help='path to mask dataset')
...
if __name__ == "__main__":
    ...
    sam, img_embedding_size = sam_model_registry[args.vit_name](image_size=args.img_size,
                                                                ...
                                                                pixel_std=[1, 1, 1])
    print(f'img_embedding_size: {img_embedding_size}')
